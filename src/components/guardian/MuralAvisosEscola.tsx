...
import { MessageSquare, AlertTriangle, Info, Megaphone, Loader2, CheckCircle2, School } from 'lucide-react';
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border-2 transition-all overflow-hidden ${
                    comunicado.lido
                      ? 'bg-secondary/10 border-border/50 opacity-80'
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap mb-2">
                          ...
                          {comunicado.lido && (
                            <Badge variant="outline" className="text-[10px] px-1.5 py-0.5 bg-emerald-500/10 text-emerald-600 border-emerald-500/20">
...
export default MuralAvisosEscola;
